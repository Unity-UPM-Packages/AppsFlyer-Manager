# com.thelegends.appsflyer.manager


A com.thelegends.appsflyer.manager package for the [Unity](https://unity.com/) Game Engine.
...
- Add the `com.thelegends.appsflyer.manager` package
